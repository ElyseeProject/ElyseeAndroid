...
public class SQLiteDatabasePool
{
	...
	public synchronized void createPool()
	{
		...
		if (pSQLiteDatabases != null) { return; // 如果己经创建，则返回
		}
	...
	{
		// 确保连接池己被创建
		if (pSQLiteDatabases == null) { return null; // 连接池还没创建，则返回 null
		}

		BaseSQLiteDatabase sqliteDatabase = getFreeSQLiteDatabase(); // 获得一个可用的数据库连接
	...
	{
		BaseSQLiteDatabase sqliteDatabase = null;// 数据库连接
